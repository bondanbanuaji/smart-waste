    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="relative text-slate-500 hover:text-slate-800 hover:bg-slate-100 rounded-full h-10 w-10">
            ...
            <DropdownMenuContent align="end" className="w-80 p-0 rounded-xl shadow-xl overflow-hidden border-slate-100">
                <div className="flex items-center justify-between px-4 py-3 bg-slate-50/80 backdrop-blur-sm border-b border-slate-100">
                    <p className="font-semibold text-sm text-slate-800">Notifikasi</p>
                    {unreadCount > 0 && (
                        <Button variant="ghost" size="sm" onClick={markAllAsRead} className="h-auto p-0 text-xs text-slate-500 hover:text-green-600 hover:bg-transparent">
                            ...
                            {notifications.map((n) => (
                                <div key={n.id} className="p-4 hover:bg-slate-50 transition-colors flex gap-3 group">
                                    ...
                                    <Button
                                        variant="ghost"
                                        size="icon"
                                        className="shrink-0 h-8 w-8 text-slate-400 opacity-0 group-hover:opacity-100 hover:text-green-600 hover:bg-green-50 transition-all rounded-full"
